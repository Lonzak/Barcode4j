...
public class RoyalMailCBCTest {
    ...
    public void testChecksum() {
        ...
        Assert.assertEquals('K', check);
    }
    
	@Test
    public void testChecksumHandling() {
        String msg = "SN34RD1A";
        ...
        Assert.assertEquals("SN34RD1AK", res);
        ...
        try {
            ...
            Assert.fail("IllegalArgumentException expected on invalid checksum");
        ...
        res = logic.handleChecksum(msg);
        Assert.assertEquals("SN34RD1A", res);
    }
