...
public class EAN128Test {
    ...
    public void testAI() {
        ...
        Assert.assertEquals("(230)n1 (fixed)", ret.toString());
        ...
        Assert.assertEquals("(8100)712345(21)12345678", impl.getHumanReadableMsg());
        Assert.assertEquals(FNC1 + "8100712345" + FNC1 + "2112345678", impl.getCode128Msg());
        ...
        Assert.assertEquals("(420)12345(91)01123456789123456780", impl.getHumanReadableMsg());
        Assert.assertEquals(FNC1 + "42012345" + FNC1 + "9101123456789123456780", impl.getCode128Msg());

        //Test check digit generation in the middle of a field
        impl = new EAN128LogicImpl(ChecksumMode.CP_AUTO, null);
        impl.setMessage("80031234567890123" + CD + "123" + GS + "1001234");
        Assert.assertEquals("(8003)12345678901231123(10)01234", impl.getHumanReadableMsg());
        Assert.assertEquals(FNC1 + "800312345678901231123" + FNC1 + "1001234", impl.getCode128Msg());

        //Test if trailing FNC1 is removed.
        impl = new EAN128LogicImpl(ChecksumMode.CP_AUTO, null);
        impl.setMessage("011234567890123" + CD + "1001234" + GS);
        Assert.assertEquals("(01)12345678901231(10)01234", impl.getHumanReadableMsg());
        Assert.assertEquals(FNC1 + "0112345678901231" + "1001234", impl.getCode128Msg());
        ...
        Assert.assertEquals("(10)12(420)12345", impl.getHumanReadableMsg());
        Assert.assertEquals(FNC1 + "1012" + FNC1 + "42012345", impl.getCode128Msg());
        ...
        Assert.assertEquals("(11)071231", impl.getHumanReadableMsg());
        Assert.assertEquals(FNC1 + "11071231", impl.getCode128Msg());
	...
	@Test
    public void testSupportRequests() {
        final char FNC1 = Code128LogicImpl.FNC_1;
        final char GS = EAN128Bean.DEFAULT_GROUP_SEPARATOR;
        final char CD = EAN128Bean.DEFAULT_CHECK_DIGIT_MARKER;
        EAN128LogicImpl impl;
        ...
        impl.setMessage("415770105500005" + CD + FNC1
                ...
                + "9620080402");
        //impl.setMessage("42012345" + FNC1 + "910112345678912345678" + CD);
        Assert.assertEquals("(415)7701055000054(8020)9115675110080555(3900)00021170(96)20080402",
                impl.getHumanReadableMsg());
        Assert.assertEquals(FNC1 + "4157701055000054" 
                + "80209115675110080555" + FNC1 
                + "390000021170" + FNC1 
