...
public class USPSIntelligentMailTest {
	...
	@Test
    public void testCharLookupTableInitialization() {
        //random/spot checks
        Assert.assertEquals(31, USPSIntelligentMailLogicImpl.TABLE5OF13[0]);
        Assert.assertEquals(7936, USPSIntelligentMailLogicImpl.TABLE5OF13[1]);
        Assert.assertEquals(47, USPSIntelligentMailLogicImpl.TABLE5OF13[2]);
        Assert.assertEquals(7808, USPSIntelligentMailLogicImpl.TABLE5OF13[3]);
        Assert.assertEquals(6368, USPSIntelligentMailLogicImpl.TABLE5OF13[93]);
        Assert.assertEquals(1077, USPSIntelligentMailLogicImpl.TABLE5OF13[500]);
        Assert.assertEquals(2641, USPSIntelligentMailLogicImpl.TABLE5OF13[1000]);
        Assert.assertEquals(856, USPSIntelligentMailLogicImpl.TABLE5OF13[1284]);
        Assert.assertEquals(744, USPSIntelligentMailLogicImpl.TABLE5OF13[1285]);
        Assert.assertEquals(496, USPSIntelligentMailLogicImpl.TABLE5OF13[1286]);

        Assert.assertEquals(3, USPSIntelligentMailLogicImpl.TABLE2OF13[0]);
        Assert.assertEquals(6144, USPSIntelligentMailLogicImpl.TABLE2OF13[1]);
        Assert.assertEquals(5, USPSIntelligentMailLogicImpl.TABLE2OF13[2]);
        Assert.assertEquals(5120, USPSIntelligentMailLogicImpl.TABLE2OF13[3]);
        Assert.assertEquals(144, USPSIntelligentMailLogicImpl.TABLE2OF13[50]);
        Assert.assertEquals(513, USPSIntelligentMailLogicImpl.TABLE2OF13[60]);
        Assert.assertEquals(520, USPSIntelligentMailLogicImpl.TABLE2OF13[75]);
        Assert.assertEquals(272, USPSIntelligentMailLogicImpl.TABLE2OF13[76]);
        Assert.assertEquals(160, USPSIntelligentMailLogicImpl.TABLE2OF13[77]);
    }
    ...
    public void testBinaryConversion() {
        ...
        for (int i = 0; i < EXAMPLE_MESSAGES.length; i++) {
            ...
            Assert.assertEquals(results[i], hexBinary);
        }
    }
    ...
    public void testFCS() {
        for (int i = 0; i < EXAMPLE_MESSAGES.length; i++) {
            ...
            Assert.assertEquals(EXAMPLE_FCS[i], fcs);
        }
    }
    ...
    public void testCodewords() {
        for (int i = 0; i < EXAMPLE_MESSAGES.length; i++) {
            ...
            Assert.assertTrue(Arrays.equals(EXAMPLE_CODEWORDS[i], codewords));
        }
    }
    ...
    public void testCodewordModification() {
        for (int i = 0; i < EXAMPLE_CODEWORDS.length; i++) {
            ...
            Assert.assertTrue("Array " + i + " does not match",
    ...
    public void testBarProduction() {
        for (int i = 0; i < EXAMPLE_MODIFIED.length; i++) {
            ...
            Assert.assertEquals(EXAMPLE_BARS[i], bars);
        }
    }
    ...
    public void testDefaultsInXML() throws Exception {
        ...
        Assert.assertEquals(refBean.getAscenderHeight(), xmlBean.getAscenderHeight(), 0.01);
        ...
        Assert.assertEquals(refBean.getTrackHeight(), xmlBean.getTrackHeight(), 0.01);
    ...
    public void testLogic() {
        ...
        for (int i = 0; i < formatted.length; i++) {
            ...
            Assert.assertEquals("Expected result n� " + i + " does not match", expected, sb.toString());
        }
    }
