...
public class HighLevelEncoderTest implements PDF417Constants {
	...
	@Test
    public void testFindNumericSequence() {
	...
	@Test
    public void testFindTextSequence() {
        ...
        Assert.assertEquals(0, count); //0 because the string has a 13+ numeric sequence
    }
    ...
    @Test
    public void testFindBinarySequence() {
        String msg;
        byte[] bytes;
        int count;
        ...
        try {
            count = PDF417HighLevelEncoder.determineConsecutiveBinaryCount(msg, bytes, 0);
            Assert.fail("The Euro character is not encodable in cp437."
    ...
    @Test
    public void testEncodeTextLatching() {
        String msg = "417'<x>";
        String result = TestHelper.visualize(PDF417HighLevelEncoder.encodeHighLevel(msg));
    ...
    public void testEncodeBinary() throws Exception{
        ...
        Assert.assertEquals(expected, TestHelper.visualize(sb.toString()));
    ...
    @Test
    public void testEncodeHighLevel() {
        String msg = "000213298174000";
        String result = TestHelper.visualize(PDF417HighLevelEncoder.encodeHighLevel(msg));
