...
public class UPCEANTest {
	...
	@Test
    public void testRemoveSupplemental() {
		Assert.assertEquals("1234", UPCEANLogicImpl.removeSupplemental("1234"));
		Assert.assertEquals("1234", UPCEANLogicImpl.removeSupplemental("1234+20"));
    }

	@Test
    public void testRetrieveSupplemental() {
		Assert.assertNull(UPCEANLogicImpl.retrieveSupplemental("1234"));
		Assert.assertEquals("20", UPCEANLogicImpl.retrieveSupplemental("1234+20"));
    }
    
	@Test
    public void testGetSupplementalLength() {
		Assert.assertEquals(0, UPCEANLogicImpl.getSupplementalLength("1234"));
		Assert.assertEquals(2, UPCEANLogicImpl.getSupplementalLength("1234+12"));
		Assert.assertEquals(5, UPCEANLogicImpl.getSupplementalLength("1234+12345"));
        try {
