...
public class Interleaved2Of5Test {
	...
	public void testChecksum() {
        ...
        Assert.assertEquals('5', Interleaved2Of5LogicImpl.calcChecksum("123456789"));

        Assert.assertTrue(Interleaved2Of5LogicImpl.validateChecksum("1234567895"));
        Assert.assertFalse(Interleaved2Of5LogicImpl.validateChecksum("1234567896"));

        //Check with German Post Identcode and Leitcode specification
        Assert.assertEquals('6', Interleaved2Of5LogicImpl.calcChecksum("12345678901", 4, 9));
    }
