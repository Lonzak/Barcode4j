...
public class ITF14Test {
    ...
    private static void checkPositive(String msg, Interleaved2Of5LogicImpl logic,
    ...
    private static void checkNegative(String msg, Interleaved2Of5LogicImpl logic, StringBuffer sb) {
        try {
            sb.setLength(0);
            logic.generateBarcodeLogic(new MockClassicBarcodeLogicHandler(sb, false, false),
                    msg);
