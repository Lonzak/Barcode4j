...
public class Code39Test {
    ...
    public void testChecksum() {
        Assert.assertEquals('L', Code39LogicImpl.calcChecksum("12345ABCDEZ/"));
        Assert.assertEquals('L', Code39LogicImpl.calcChecksum("12345abcdez/"));
        Assert.assertEquals('M', Code39LogicImpl.calcChecksum("494140"));
        Assert.assertEquals('P', Code39LogicImpl.calcChecksum("415339"));
    }
    ...
    public void testIllegalChars() {
        ...
        try {
            ...
            Assert.fail("Must not complain about '*' if used properly in stadard mode!");
        }
        ...
        try {
            ...
            Assert.fail("Must not complain about '*' with extended charset enabled!");
        }
    }
	...
	@Test
    public void testDisplayStartStop() {
        StringBuffer sb = new StringBuffer();
        Code39LogicImpl logic;
        String expected;
	...
	@Test
    public void testDisplayChecksum() {
        StringBuffer sb = new StringBuffer();
        Code39LogicImpl logic;
        String expected;
	...
	@Test
    public void testExtendedCharSet() {
    ...
    public void testDimension() {
        ...
        Assert.assertEquals(24.94, dim.getWidth(), 0.02);
        Assert.assertEquals(28.74, dim.getWidthPlusQuiet(), 0.02);
        Assert.assertEquals(14.0, dim.getHeight(), 0.02);
        Assert.assertEquals(14.0, dim.getHeightPlusQuiet(), 0.02);
        Assert.assertEquals(1.9, dim.getXOffset(), 0.02);
        Assert.assertEquals(0, dim.getYOffset(), 0.02);
        ...
        dim = bean.calcDimensions("*test*");
        Assert.assertEquals(58.58, dim.getWidth(), 0.02);
        Assert.assertEquals(62.38, dim.getWidthPlusQuiet(), 0.02);
        Assert.assertEquals(14.0, dim.getHeight(), 0.02);
        Assert.assertEquals(14.0, dim.getHeightPlusQuiet(), 0.02);
        Assert.assertEquals(1.9, dim.getXOffset(), 0.02);
        Assert.assertEquals(0, dim.getYOffset(), 0.02);
        ...
        Assert.assertEquals(41.76, dim.getWidth(), 0.02);
        Assert.assertEquals(45.56, dim.getWidthPlusQuiet(), 0.02);
        Assert.assertEquals(14.0, dim.getHeight(), 0.02);
        Assert.assertEquals(14.0, dim.getHeightPlusQuiet(), 0.02);
        Assert.assertEquals(1.9, dim.getXOffset(), 0.02);
        Assert.assertEquals(0, dim.getYOffset(), 0.02);
