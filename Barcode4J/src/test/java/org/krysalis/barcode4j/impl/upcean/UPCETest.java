...
public class UPCETest {
    ...
    public void testIllegalArguments() {
        ...
        try {
            ...
            Assert.fail("Expected an exception complaining about invalid message length");
        } catch (IllegalArgumentException iae) {
            //must fail
        }
    ...
    @Test
    public void testMessageCompaction() {
        ...
        Assert.assertNull(UPCELogicImpl.compactMessage(noUPCE));
        Assert.assertNull(UPCELogicImpl.compactMessage(noUPCE + UPCEANLogicImpl.calcChecksum(noUPCE)));
        try {
            UPCELogicImpl.compactMessage("ajsgf");
            Assert.fail("Invalid messages must fail");
        } catch (IllegalArgumentException iae) {
            //must fail
        }
        try {
