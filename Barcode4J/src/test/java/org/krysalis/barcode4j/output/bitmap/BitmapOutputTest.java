...
public class BitmapOutputTest {
    ...
    private static BarcodeGenerator getGenerator() throws ConfigurationException, BarcodeException {
    ...
    public void testBitmap() throws Exception {
        ...
        Assert.assertEquals("Width in pixels should be 107", 107, image.getWidth());
        Assert.assertEquals("Height in pixels should be 140", 140, image.getHeight());
    }
    ...
    public void testBitmapFile() throws Exception {
        ...
        Assert.assertTrue(baout.size() > 0);
    }
