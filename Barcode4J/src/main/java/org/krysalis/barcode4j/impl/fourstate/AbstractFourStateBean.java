...
public abstract class AbstractFourStateBean extends HeightVariableBarcodeBean {
	...
	public double getBarHeight(int height) {
        switch (height) {
        case 0: return this.trackHeight;
        case 1: return this.trackHeight + this.ascenderHeight;
        case 2: return this.trackHeight + this.ascenderHeight;
        case 3: return this.trackHeight + (2 * this.ascenderHeight);
