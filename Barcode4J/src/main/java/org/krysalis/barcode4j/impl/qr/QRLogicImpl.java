...
public class QRLogicImpl implements QRConstants {
    ...
    public void generateBarcodeLogic(TwoDimBarcodeLogicHandler logic, String msg,
        ...
        HashMap<EncodeHintType, String> hints = createHints(encoding);
    ...
    static HashMap<EncodeHintType, String> createHints(String encoding) {
    ...
    private static void encodeLowLevel(TwoDimBarcodeLogicHandler logic, ByteMatrix matrix) {
