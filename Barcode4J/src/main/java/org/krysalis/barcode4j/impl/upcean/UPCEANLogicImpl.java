...
public abstract class UPCEANLogicImpl {
    ...
    private static int widthAt(char ch, int index) {
     ...
     * @param logic the logic handler to receive generated events
     */
    private static void drawSuppLeftGuard(ClassicBarcodeLogicHandler logic) {
     ...
     * @param logic the logic handler to receive generated events
     */
    private static void drawSuppSeparator(ClassicBarcodeLogicHandler logic) {
