...
public class QRCodeBean extends AbstractBarcodeBean {
    ...
    public QRCodeBean() {
        ...
        setQuietZone(QRConstants.QUIET_ZONE_SIZE * this.moduleWidth);
    }
	...
	public void generateBarcode(CanvasProvider canvas, String msg) {
        ...
        impl.generateBarcodeLogic(handler, msg, this.encoding, this.errorCorrectionLevel,
	...
	public BarcodeDimension calcDimensions(String msg) {
        ...
        try {
        	code = Encoder.encode(msg,
                    QRLogicImpl.getZXingErrorLevel(this.errorCorrectionLevel),
                    QRLogicImpl.createHints(this.encoding));
