...
public class PDF417Bean extends AbstractBarcodeBean {
    ...
    public PDF417Bean() {
        ...
        this.height = DEFAULT_X_TO_Y_FACTOR * this.moduleWidth;
        setQuietZone(2 * this.moduleWidth);
    ...
    private static void checkValidColumnCount(int cols) {
    ...
    private static void checkValidRowCount(int rows) {
