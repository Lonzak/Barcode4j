...
public class Java2DCanvasProvider extends AbstractCanvasProvider {
	...
	public void establishDimensions(BarcodeDimension dim) {
        ...
        switch (orientation) {
        case 90:
            this.g2d.rotate(-Math.PI / 2);
            this.g2d.translate(-h, 0);
            break;
        case 180:
            ...
            break;
        case 270:
            this.g2d.rotate(-Math.PI * 1.5);
            this.g2d.translate(0, -w);
            break;
        default:
            //nop
        }
	...
	public void deviceText(
        ...
        if (DEBUG) {
            this.g2d.setStroke(new BasicStroke(0.01f));
            this.g2d.draw(new Rectangle2D.Double(x1, y1 - fontSize, 
                x2 - x1, fontSize));
            this.g2d.draw(new Rectangle2D.Double(x1 + indent, 
                y1 - fontSize, 
                textwidth, fontSize));
        }
    }
