...
public class BarcodeTask extends Task {
	...
	public void execute() throws BuildException {
        ...
        try {
            OutputStream out = new java.io.FileOutputStream(this.output);

            this.format = MimeTypes.expandFormat(this.format);

            int orientation = 0;
            log("Generating " + this.symbol + " in " + this.format + "...");
            ...
            if (MimeTypes.MIME_SVG.equals(this.format)) {
                ...
                if (this.bw) {
                    bitmap = new BitmapCanvasProvider(out, this.format, this.dpi,
    ...
    private Configuration getConfiguration() {
        ...
        if (this.configurationFile != null) {
            try {
                ...
                log("Using configuration: " + this.configurationFile);
