...
public class BarcodeXMLHandler implements XMLHandler, RendererContextConstants {
    ...
    private static void renderUsingEPS(RendererContext context, BarcodeGenerator bargen,
    ...
    private static boolean renderUsingGraphics2D(RendererContext context,
    ...
    private static boolean renderUsingBitmap(RendererContext context,
            final BarcodeGenerator bargen,
            final String msg, final int orientation) throws IOException {
     ...
     */
    private static void convertToSVG(RendererContext context,
